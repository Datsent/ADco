...
class AWB_Settings {
    ...
    public function get_settings_sections() {
        $sections = array(
            ...
            array(
                'id'    => 'awb_pro',
                'title' => esc_html__( 'PRO', 'advanced-backgrounds' ),
            ),
        );
    ...
    public function print_settings_page() {
        ...
        wp_enqueue_style( 'nk-awb-settings', nk_awb()->plugin_url . 'assets/admin/settings/style.min.css', '', '1.5.4' );
        wp_enqueue_script( 'nk-awb-settings', nk_awb()->plugin_url . 'assets/admin/settings/script.min.js', array( 'jquery' ), '1.5.4' );
    }
}
new AWB_Settings();
